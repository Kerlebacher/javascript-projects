...
//1) Replace the gene "GCT" with "AGG", and then print the altered strand.  Not working?!
...
let lengthDna = dnaTwo.length
console.log(`The DNA strand is ${lengthDna} characters long.`)
